...
PatchboardJson::ReturnCode PatchboardJson::parse(const std::string &patchboardStr)
{
	Json::Reader reader;
	reader.parse(patchboardStr, patchboard);
  ...
  // ToDo: figure out how to utilize a reusable function for repetitive checks
...
PatchboardJson& PatchboardJson::operator=(const PatchboardJson & p)
{
